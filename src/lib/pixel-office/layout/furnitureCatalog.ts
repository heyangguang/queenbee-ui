...
import {
  ...
  TS_SERVER_RACK, TS_PING_PONG, TS_BASKETBALL, TS_FITNESS, TS_VENDING,
...
export const FURNITURE_CATALOG: CatalogEntryWithCategory[] = [
  ...
  { type: FurnitureType.SOFA, label: 'Sofa', footprintW: 2, footprintH: 1, sprite: SOFA_SPRITE, isDesk: false, category: 'decor' },
  ...
  { type: FurnitureType.CLOCK, label: 'Clock', footprintW: 1, footprintH: 1, sprite: TS_CLOCK, isDesk: false, category: 'decor', canPlaceOnWalls: true },
  ...
  { type: FurnitureType.PAINTING_LARGE_1, label: 'Painting Large 1', footprintW: 2, footprintH: 1, sprite: TS_PAINTING_LARGE_1, isDesk: false, category: 'decor', canPlaceOnWalls: true },
  { type: FurnitureType.PAINTING_LARGE_2, label: 'Painting Large 2', footprintW: 2, footprintH: 1, sprite: TS_PAINTING_LARGE_2, isDesk: false, category: 'decor', canPlaceOnWalls: true },
  { type: FurnitureType.PAINTING_SMALL_1, label: 'Painting Small 1', footprintW: 1, footprintH: 1, sprite: TS_PAINTING_SMALL_1, isDesk: false, category: 'decor', canPlaceOnWalls: true },
  { type: FurnitureType.PAINTING_SMALL_2, label: 'Painting Small 2', footprintW: 1, footprintH: 1, sprite: TS_PAINTING_SMALL_2, isDesk: false, category: 'decor', canPlaceOnWalls: true },
  { type: FurnitureType.PAINTING_SMALL_3, label: 'Painting Small 3', footprintW: 1, footprintH: 1, sprite: TS_PAINTING_SMALL_3, isDesk: false, category: 'decor', canPlaceOnWalls: true },
  // ── 新增 — 服务器和运动设施 ──
  { type: FurnitureType.SERVER_RACK, label: '服务器机架', footprintW: 1, footprintH: 2, sprite: TS_SERVER_RACK, isDesk: false, category: 'electronics' },
  { type: FurnitureType.PING_PONG, label: '乒乓球台', footprintW: 2, footprintH: 1, sprite: TS_PING_PONG, isDesk: false, category: 'decor' },
  { type: FurnitureType.BASKETBALL, label: '篮球架', footprintW: 1, footprintH: 2, sprite: TS_BASKETBALL, isDesk: false, category: 'decor' },
  { type: FurnitureType.FITNESS, label: '健身器材', footprintW: 1, footprintH: 1, sprite: TS_FITNESS, isDesk: false, category: 'decor' },
  { type: FurnitureType.VENDING, label: '自动售货机', footprintW: 1, footprintH: 2, sprite: TS_VENDING, isDesk: false, category: 'electronics' },
]
